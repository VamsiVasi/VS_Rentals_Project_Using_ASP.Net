...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:rentConnectionString %>" SelectCommand="SELECT [picture], [productid], [productname], [producttype], [description], [rent], [availstate], [availcity], [vendorname] FROM [products] WHERE (([producttype] = @producttype) AND ([availcity] = @availcity))">
        <SelectParameters>
