<%@ Page Language="C#" MasterPageFile="~/vendor.master" AutoEventWireup="true" CodeFile="product added.aspx.cs" Inherits="product_added" Title="product added" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:Label ID="lblmsg" runat="server" Font-Size="25pt" Style="z-index: 100;
    ...
    <asp:Label ID="Label1" runat="server" Font-Size="25pt" Style="z-index: 100;
        left: 278px; position: absolute; top: 265px; height: 44px; width: 807px;" Font-Names="Agency FB" ForeColor="White"></asp:Label>
    <br />
   <asp:HyperLink ID="HyperLink1" runat="server"  Font-Bold="True" Font-Size="Large"
    ...
    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" Style="z-index: 103;
        left: 523px; position: absolute; top: 321px; height: 27px;" Text="To Add Another Product" Font-Italic="True" ForeColor="#400000"></asp:Label>
        </asp:Content>
