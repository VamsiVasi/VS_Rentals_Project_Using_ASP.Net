...
public partial class vendor : System.Web.UI.Page
{
    ...
    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection cn1= new SqlConnection(cs1);
        SqlCommand cmd1 = new SqlCommand("select * from products where vendorname='" + Session["vuname"].ToString() + "'", cn1);
        cn1.Open();
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select * from booking,products where ldate > getdate() and booking.ProductId=products.productid and vendorname='" + Session["vuname"].ToString() + "'", cn);
        cn.Open();
