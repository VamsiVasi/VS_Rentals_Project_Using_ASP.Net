<%@ Page Language="C#" MasterPageFile="~/vendor.master" AutoEventWireup="true" CodeFile="unregister.aspx.cs" Inherits="unregister" Title="Unregister" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="White" Style="z-index: 100;
                    ...
                    Text="Account Deletion" Width="390px" Font-Names="Agency FB" Font-Size="25pt" Font-Underline="False"></asp:Label>
