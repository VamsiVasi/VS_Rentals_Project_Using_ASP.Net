<%@ Page Language="C#" MasterPageFile="~/selectcategory.master" AutoEventWireup="true" CodeFile="homeappliances.aspx.cs" Inherits="select_city6" Title="Home Appliances" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Agency FB" Font-Size="25pt" Font-Underline="False" ForeColor="White" Style="z-index: 100;
                    left: 488px; position: absolute; top: 115px;  text-align: center; height: 43px;" Text="Home Appliances" Width="390px"></asp:Label>
    <asp:Label ID="Label1" runat="server" Text="Home Appliances" Visible="False"></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:rentConnectionString %>" ProviderName="<%$ ConnectionStrings:rentConnectionString.ProviderName %>" SelectCommand="SELECT picture, productid, productname, producttype, description, rent, availstate, availcity, vendorname FROM products WHERE (producttype = @producttype)">
        <SelectParameters>
            <asp:Parameter DefaultValue="Home Appliances" Name="producttype" Type="String" />
