...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:rentConnectionString %>" ProviderName="<%$ ConnectionStrings:rentConnectionString.ProviderName %>" SelectCommand="SELECT products.productid, products.picture, products.productname, products.producttype, booking.bname, booking.bemail, booking.bphnumber, booking.bnumpieces, products.rent, booking.pdate, booking.ldate, products.availstate, products.availcity, products.vendorname FROM booking INNER JOIN products ON booking.productid = products.productid"></asp:SqlDataSource>
...
<asp:BoundField DataField="vdate" HeaderText="Date Of Birth" DataFormatString="{0:D}" SortExpression="vdate"></asp:BoundField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:rentConnectionString %>" ProviderName="<%$ ConnectionStrings:rentConnectionString.ProviderName %>" SelectCommand="SELECT vuname, vdate, vmobile, vtel, vemail, vstate, vcity, vgender FROM vendortab"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:rentConnectionString %>" ProviderName="<%$ ConnectionStrings:rentConnectionString.ProviderName %>" SelectCommand="SELECT productid, picture, productname, producttype, description, availstate, availcity, rent, status, vendorname FROM products"></asp:SqlDataSource>
...
<asp:BoundField DataField="femail" HeaderText="Email Id" SortExpression="femail"></asp:BoundField>
    ...
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:rentConnectionString %>" ProviderName="<%$ ConnectionStrings:rentConnectionString.ProviderName %>" SelectCommand="SELECT fname, femail, feedback FROM feedback"></asp:SqlDataSource>
    <br />
    <br />
    <br />
    <br />
