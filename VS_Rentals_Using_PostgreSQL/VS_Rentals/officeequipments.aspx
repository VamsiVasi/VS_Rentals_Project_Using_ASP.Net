<%@ Page Language="C#" MasterPageFile="~/selectcategory.master" AutoEventWireup="true" CodeFile="officeequipments.aspx.cs" Inherits="select_city7" Title="Office Equipments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Agency FB" Font-Size="25pt" Font-Underline="False" ForeColor="White" Style="z-index: 100;
                    left: 488px; position: absolute; top: 115px;  text-align: center; height: 43px;" Text="Office Equipments" Width="390px"></asp:Label>
    <asp:Label ID="Label1" runat="server" Text="Office Equipments" Visible="False"></asp:Label>
